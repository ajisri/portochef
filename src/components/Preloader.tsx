...
export default function Preloader() {
  ...
  return (
    <div ref={containerRef} className="fixed inset-0 z-[9999] pointer-events-none">
      ...
      <div className="panel-top absolute top-0 left-0 w-full h-1/2 bg-background transition-colors duration-500 pointer-events-auto border-b border-transparent"></div>
      <div className="panel-bottom absolute bottom-0 left-0 w-full h-1/2 bg-background transition-colors duration-500 pointer-events-auto border-t border-transparent"></div>
      
      {/* Garis Sayatan (Pisau) berada di titik tengah absolut */}
      <div className="the-cut absolute top-1/2 left-1/2 h-[1px] w-0 bg-foreground transition-colors duration-500 -translate-x-1/2 -translate-y-1/2 z-20"></div>
